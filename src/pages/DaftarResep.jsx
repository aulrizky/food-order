...
import { getFoods, getMyCart } from "../services/apis";
      ...
      <Box sx={{ width: "auto" }}>
        ...
        >
          ...
          >
            ...
            <MenuItem value="foodName,asc">Nama Makanan A-Z</MenuItem>
            <MenuItem value="foodName,desc">Nama Makanan Z-A</MenuItem>
            <MenuItem value="price,asc">Harga (Tinggi - Rendah)</MenuItem>
            <MenuItem value="price,desc">Harga (Rendah - Tinggi)</MenuItem>
          </Select>
        </FormControl>
      </Box>
    </Box>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            ...
            >
              ...
              >
                <MenuItem value="">None</MenuItem>
                <MenuItem value="Nama Makanan A-Z">Nama Makanan A-Z</MenuItem>
                <MenuItem value="Nama Makanan Z-A">Nama Makanan Z-A</MenuItem>
                <MenuItem value="Harga (Tinggi - Rendah)">
                  Harga (Tinggi - Rendah)
                </MenuItem>
                <MenuItem value="Harga (Rendah - Tinggi)">
                  Harga (Rendah - Tinggi)
                </MenuItem>
              </Select>
            </FormControl>
...
export default function DaftarResep() {
  ...
  const [sortBy, setSortBy] = useState("foodName,asc");
